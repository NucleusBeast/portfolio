          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-300">
                  ...
                  <p>
                    I specialize in full-stack development with a strong focus on modern JavaScript frameworks, 
                    cloud technologies, and creating seamless user experiences. My passion lies in solving complex 
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Database Design</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      Designing efficient database schemas and optimizing queries
                    </p>
                  </div>
                  <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-2">DevOps & Deployment</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
            ...
            <div>
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">
                Skills & Technologies (How much I prefer it)
              </h3>
              <Skills />
            </div>
          </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">contact@nucleusbeast.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">Maribor, Slovenia</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <footer className="bg-gray-900 text-white py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-gray-400">
            © 2025 NucleusBeast. Built with Next.js and Tailwind CSS.
          </p>
        </div>
      </footer>
    </div>
